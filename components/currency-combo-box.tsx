...
import { currencies, TCurrency } from "@/lib/currencies";
import { useMutation, useQuery } from "@tanstack/react-query";
import SkeletonWrapper from "./skeleton-wrapper";
import { UserSettings } from "@prisma/client";
import { updateUserCurrency } from "@/actions/user-settings/user-settings";
...
export function CurrencyComboBox() {
  ...
  const [selectedOption, setSelectedOption] = React.useState<TCurrency | null>(
    null
  );
...
function OptionList({
  ...
  setSelectedOption: (option: TCurrency | null) => void;
}) {
  return (
    <Command>
